    ...
    private void ReadCompleted(int count)
    {
      ...
      if (dataBuffer == null)
      {
        ...
        else
        {
          ...
          {
            throw new System.Net.ProtocolViolationException("Message length " + length.ToString() + " is larger than maximum message size " + maxMessageSize.ToString());
          }
